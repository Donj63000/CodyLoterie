...
public class Roue {
    ...
    public void spinTheWheel() {
        ...
        spinRT.stop();
        spinRT.setDuration(Duration.seconds(OptionRoue.getSpinDuration()));
    ...
    private void addDecorRings() {
        ...
        for (int i = 0; i < rivetCount; i++) {
            ...
            Circle c = new Circle(r * Math.cos(ang), r * Math.sin(ang), 3, METAL_LIGHT);
    ...
    private Arc buildSector(double start, double extent, Color tint) {
        ...
        Paint fill = new RadialGradient(0, 0, 0.0, 0.0, 1, true, CycleMethod.NO_CYCLE,
